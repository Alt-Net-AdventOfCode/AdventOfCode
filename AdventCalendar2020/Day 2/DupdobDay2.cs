...
namespace AdventCalendar2020.Day_2
{
    public class DupdobDay2
    {
        ...
        public string GiveAnswer1()
        {
            ...
            foreach (var line in Input.Split('\n'))
            {
                ...
                var numbers = fields[0].Split('-');

                var min = int.Parse(numbers[0]);
                var max = int.Parse(numbers[1]);
                var marker = fields[1][0];
                var password = fields[2];

                var count = password.Count(c => c == marker);
        ...
        public string GiveAnswer2()
        {
            ...
            foreach (var line in Input.Split('\n'))
            {
                ...
                if ((password[min-1] == marker && password[max-1]!= marker)
                    || (password[min-1] != marker && password[max-1] == marker))
                    validPasswords++;
            }
        ...
        private const string Input = @"3-4 j: tjjj

...
namespace AoC
{
    public abstract class SolverWithParser : ISolver
    {
        ...
        public abstract void SetupRun(Engine engine);
        ...
        /// <remarks>Split the data as an array of lines and call <see cref="SolverWithLineParser.ParseLine"/> for each them.
        /// Override this method if you prefer to parse data as a whole (you still need to provide an empty ParseLine method
        /// as it is declared abstract).</remarks>

...
namespace AdventCalendar2019.Day9
{
    public  class DupdobDay9
    {
        ...
        {
            var puzzle = new DupdobDay9();
            puzzle.ParseInput();
            Console.WriteLine($"Answer 1: {puzzle.ComputeAnswer(1)}");
            Console.WriteLine($"Answer 1: {puzzle.ComputeAnswer(2)}");
        }
        ...
        public long ComputeAnswer(long input)
        {
            Func<long, long> inputProvider = (index) => input;
            Func<long, bool> outputHandler = (output) =>
            {
        ...
        public long RunProgram(Func<long, long> inputProvider, Func<long, bool> outputHandler)
        {
